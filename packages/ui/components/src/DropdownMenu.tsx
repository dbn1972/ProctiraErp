...
/**
 * shadcn/ui DropdownMenu primitives. Migrated from
 * `apps/web/src/components/ui/dropdown-menu.tsx` during task 60.1.
 */
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-[8rem] overflow-hidden rounded-md border bg-[hsl(var(--popover))] p-1 text-[hsl(var(--popover-foreground))] shadow-md',
        className,
      )}
      {...props}
    />
