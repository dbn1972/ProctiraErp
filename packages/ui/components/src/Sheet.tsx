...
/**
 * shadcn/ui Sheet — slide-out drawer built on `@radix-ui/react-dialog`.
 * Ported from `School Platform Design/src/app/components/ui/sheet.tsx`
 * during task 60.1 with Tailwind v3 token references so the primitive is
 * compatible with the apps/web Tailwind v3 build.
 */
