...
export interface WarehouseRepository {
  ...
  listWarehouses(tenantId: string, filter: ListFilter, page: number, pageSize: number): Promise<ListResult<Warehouse>>;

  // Indicator operations
  createIndicator(indicator: Indicator): Promise<Indicator>;
  updateIndicator(id: string, warehouseId: string, tenantId: string, updates: Partial<Indicator>): Promise<Indicator>;
  ...
  listIndicators(warehouseId: string, tenantId: string, filter: ListFilter, page: number, pageSize: number): Promise<ListResult<Indicator>>;

  // Unit operations
  createUnit(unit: Unit): Promise<Unit>;
  updateUnit(id: string, warehouseId: string, tenantId: string, updates: Partial<Unit>): Promise<Unit>;
  ...
  listUnits(warehouseId: string, tenantId: string, filter: ListFilter, page: number, pageSize: number): Promise<ListResult<Unit>>;

  // Subgroup operations
  createSubgroup(subgroup: Subgroup): Promise<Subgroup>;
  updateSubgroup(id: string, warehouseId: string, tenantId: string, updates: Partial<Subgroup>): Promise<Subgroup>;
  ...
  listSubgroups(warehouseId: string, tenantId: string, filter: ListFilter, page: number, pageSize: number): Promise<ListResult<Subgroup>>;

  // Time Period operations
  createTimePeriod(timePeriod: TimePeriod): Promise<TimePeriod>;
  updateTimePeriod(id: string, warehouseId: string, tenantId: string, updates: Partial<TimePeriod>): Promise<TimePeriod>;
  ...
  findTimePeriodByLabel(label: string, warehouseId: string, tenantId: string): Promise<TimePeriod | null>;
  listTimePeriods(warehouseId: string, tenantId: string, filter: ListFilter, page: number, pageSize: number): Promise<ListResult<TimePeriod>>;

  // Area operations
  createArea(area: Area): Promise<Area>;
  updateArea(id: string, warehouseId: string, tenantId: string, updates: Partial<Area>): Promise<Area>;
  ...
  listAreas(warehouseId: string, tenantId: string, filter: ListFilter, page: number, pageSize: number): Promise<ListResult<Area>>;
