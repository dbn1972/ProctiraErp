...
export const UpdateStaffSchema = Type.Object({
  firstName: Type.Optional(
    Type.String({ minLength: 1, maxLength: 100, description: 'Staff first name' }),
  ),
  lastName: Type.Optional(
    Type.String({ minLength: 1, maxLength: 100, description: 'Staff last name' }),
  ),
...
export const StaffListQuerySchema = Type.Object({
  ...
  search: Type.Optional(
    Type.String({ description: 'Full-text search on name and identity number' }),
  ),
  sortBy: Type.Optional(
    Type.String({
      enum: ['firstName', 'lastName', 'position', 'createdAt'],
      default: 'lastName',
...
export const StaffResponseSchema = Type.Object({
  ...
  customData: Type.Union([Type.Record(Type.String(), Type.Unknown()), Type.Null()], {
