...
module.exports = {
  ...
  create(context) {
    ...
    const allowAriaHiddenDecorative =
    ...
    return {
      JSXOpeningElement(node) {
        ...
        const widthOk =
          attributeHasValue(attrs.get("width")) ||
          styleHasProperty(styleObject, "width");
        const heightOk =
          attributeHasValue(attrs.get("height")) ||
          styleHasProperty(styleObject, "height");
