...
export const BOARD_COMPARISON_MOCK: BoardComparisonData = {
  ...
  detail: [
    // CBSE
    { id: 'cbse-passRate-2022-23', boardId: 'cbse', boardName: 'CBSE', metricId: 'passRate', metricLabel: 'Pass Rate', year: '2022-23', value: '79.8%' },
    { id: 'cbse-passRate-2023-24', boardId: 'cbse', boardName: 'CBSE', metricId: 'passRate', metricLabel: 'Pass Rate', year: '2023-24', value: '81.1%' },
    { id: 'cbse-passRate-2024-25', boardId: 'cbse', boardName: 'CBSE', metricId: 'passRate', metricLabel: 'Pass Rate', year: '2024-25', value: '82.3%' },
    { id: 'cbse-attendance-2024-25', boardId: 'cbse', boardName: 'CBSE', metricId: 'attendance', metricLabel: 'Attendance', year: '2024-25', value: '91.2%' },
    { id: 'cbse-ptr-2024-25', boardId: 'cbse', boardName: 'CBSE', metricId: 'ptr', metricLabel: 'PTR', year: '2024-25', value: '28:1' },
    // State Boards
    { id: 'state-passRate-2022-23', boardId: 'state', boardName: 'State Boards', metricId: 'passRate', metricLabel: 'Pass Rate', year: '2022-23', value: '66.1%' },
    { id: 'state-passRate-2023-24', boardId: 'state', boardName: 'State Boards', metricId: 'passRate', metricLabel: 'Pass Rate', year: '2023-24', value: '67.5%' },
    { id: 'state-passRate-2024-25', boardId: 'state', boardName: 'State Boards', metricId: 'passRate', metricLabel: 'Pass Rate', year: '2024-25', value: '68.5%' },
    { id: 'state-attendance-2024-25', boardId: 'state', boardName: 'State Boards', metricId: 'attendance', metricLabel: 'Attendance', year: '2024-25', value: '85.1%' },
    { id: 'state-ptr-2024-25', boardId: 'state', boardName: 'State Boards', metricId: 'ptr', metricLabel: 'PTR', year: '2024-25', value: '35:1' },
    // ICSE
    { id: 'icse-passRate-2022-23', boardId: 'icse', boardName: 'ICSE', metricId: 'passRate', metricLabel: 'Pass Rate', year: '2022-23', value: '87.2%' },
    { id: 'icse-passRate-2023-24', boardId: 'icse', boardName: 'ICSE', metricId: 'passRate', metricLabel: 'Pass Rate', year: '2023-24', value: '88.4%' },
    { id: 'icse-passRate-2024-25', boardId: 'icse', boardName: 'ICSE', metricId: 'passRate', metricLabel: 'Pass Rate', year: '2024-25', value: '89.1%' },
    { id: 'icse-attendance-2024-25', boardId: 'icse', boardName: 'ICSE', metricId: 'attendance', metricLabel: 'Attendance', year: '2024-25', value: '94.5%' },
    { id: 'icse-ptr-2024-25', boardId: 'icse', boardName: 'ICSE', metricId: 'ptr', metricLabel: 'PTR', year: '2024-25', value: '22:1' },
    // IB
    { id: 'ib-passRate-2022-23', boardId: 'ib', boardName: 'IB', metricId: 'passRate', metricLabel: 'Pass Rate', year: '2022-23', value: '93.5%' },
    { id: 'ib-passRate-2023-24', boardId: 'ib', boardName: 'IB', metricId: 'passRate', metricLabel: 'Pass Rate', year: '2023-24', value: '94.2%' },
    { id: 'ib-passRate-2024-25', boardId: 'ib', boardName: 'IB', metricId: 'passRate', metricLabel: 'Pass Rate', year: '2024-25', value: '95.0%' },
    { id: 'ib-attendance-2024-25', boardId: 'ib', boardName: 'IB', metricId: 'attendance', metricLabel: 'Attendance', year: '2024-25', value: '96.2%' },
    { id: 'ib-ptr-2024-25', boardId: 'ib', boardName: 'IB', metricId: 'ptr', metricLabel: 'PTR', year: '2024-25', value: '15:1' },
  ],
};
