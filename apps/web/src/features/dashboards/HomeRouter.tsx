...
const BoardComparisonDashboard = lazy(
  () => import('./pages/BoardComparisonDashboard'),
);
const CrossBoardTransferDashboard = lazy(
  () => import('./pages/CrossBoardTransferDashboard'),
);
  ...
  return (
    ...
    >
      <Routes>
        ...
        <Route
          path="cross-board-transfer"
          element={<CrossBoardTransferDashboard />}
        />
        <Route
          path="cross-board-transfer/:transferId"
          element={<CrossBoardTransferDashboard />}
        />
      </Routes>
    </Suspense>
