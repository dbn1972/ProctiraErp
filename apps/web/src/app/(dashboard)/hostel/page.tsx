...
export default async function HostelPage() {
  ...
  return (
    <section className="space-y-6" aria-labelledby="hostel-heading">
      <div>
        <h1 id="hostel-heading" className="text-3xl font-extrabold tracking-tight">
          Hostel
        </h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Phase 21 MVP — Hostel list
        </p>
      </div>
