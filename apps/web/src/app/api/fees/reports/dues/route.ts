...
export async function GET(): Promise<Response> {
  ...
  const upstream = await fetch(`${GATEWAY_BASE_URL}${GATEWAY_API_PREFIX}/fees/reports/dues?format=csv`, {
  ...
  return new NextResponse(upstream.body, {
    ...
    headers: {
      ...
      'content-disposition':
        upstream.headers.get('content-disposition') ?? 'attachment; filename="fees-dues-report.csv"',
