...
export const metadata: Metadata = {
  title: 'Cookie Policy',
  description: 'How ProctiraERP uses cookies and similar technologies on our website.',
    ...
    <>
      ...
      <section className="container py-16">
        <div className="mx-auto mb-8 flex max-w-3xl items-center gap-2.5 rounded-md border border-primary/20 bg-primary/5 px-4 py-3 text-sm font-medium text-primary">
          ...
          Applies to proctira.org and its subdomains — review and update before public launch.
        </div>
        <LegalProse>
          <p>
            This Cookie Policy explains how the ProctiraERP public website and services use cookies
            and similar technologies. It complements our <a href="/privacy">Privacy Policy</a>.
          </p>

          <h2>What are cookies?</h2>
          <p>
            Cookies are small text files that a website stores on your device. They allow a site to
            remember your actions and preferences over time so you do not have to repeat them.
          </p>

          <h2>How we use cookies</h2>
          <ul>
            <li>
              <strong>Strictly necessary</strong> cookies enable core site functions such as
            ...
            <li>
              ...
              the site so we can improve it. These are only set with your consent where required.
            </li>
          </ul>
          ...
          <p>
            We may update this policy as our cookie usage changes. Material updates will be
