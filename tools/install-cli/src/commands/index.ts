...
export type { ReadinessReport, ReadinessCategory, ReadinessStatus, ReadinessOptions } from './readiness';
...
export type { UpgradeCheckResult, CompatibilityCheck, UpgradeDecision, UpgradeCheckOptions } from './upgrade-check';
