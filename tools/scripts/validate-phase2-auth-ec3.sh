#!/usr/bin/env bash
# Phase 2 EC3 validation checklist (optional Keycloak + India admin login).
# Default CI does not run this. On main, identity/invite/OTP stores are in-memory unless a live IdP + secrets are provided.
