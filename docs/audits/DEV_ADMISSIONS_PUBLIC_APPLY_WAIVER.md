# DEV — Admissions public apply + applicant IdP waiver (A3 / A-1)

**Capability / module:** Admissions CRM → enrol — public apply residual honesty  
**Branch / tip:** `cursor/adm-public-apply-waiver-56c3`  
**Date (UTC):** 2026-09-12  
**Product contract:** `docs/audits/PRODUCT_ADMISSIONS_ENROL_JOURNEY.md` (§3 Decision A-1)  
**Waiver board:** `docs/audits/WAIVER_BOARD_20260910.md` (**PRD-016**)
