...
| `backend/gradebook`           | Yes      | `/gradebook`                                                                                      | Raw pg `003`/`004`/`032` (else in-memory)                  | No          | G-907 publish, rank/CGPA, comments bank, grade-change audit.                                         |
| `backend/curriculum`         | Yes      | `/curriculum`                                                                                     | Raw pg `033` (else in-memory)                              | No          | G-923 syllabus units, lesson plans, outcomes, coverage %.                                            |
