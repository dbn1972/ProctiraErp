...
**Tip:** `3c93595` · Prefer fixing Sev S0→S1 before polishing S3.  
...
| ------- | -------------- | ---------------------------- | --- | -------- | ---------------------------------------------------------- | ------------------------------------ | ------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- | ------------- | ---- | ----- |
| PRD-001 | Release        | Tip CI / PR #48              | S0  | Release  | Tip not CI-green; Integration Tests flake on prior tip     | `gh pr checks 48`; prior IT fail log | Stabilize / retrigger IT; fix only if reproducible product bug                                                | All required checks green on tip SHA                     | —             | M    | 1     |
