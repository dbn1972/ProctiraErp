...
Counted from the tables below. `PASS` count is 0.
...
| Library | `NOT_RUN` | 7 | 7 | 0 | `unassigned` |
| Hostel | `NOT_RUN` | 8 | 8 | 0 | `unassigned` |
| Transport | `NOT_RUN` | 9 | 9 | 0 | `unassigned` |
...
| Route | Actor | Primary action | Result | Evidence | Owner worker |
| --- | --- | --- | --- | --- | --- |
| `/library` | staff admin (Sunrise) | Open the library home. Honest empty if no catalogue row is seeded. | `NOT_RUN` | not exercised | `unassigned` |
| `/library/opac` | staff admin (Sunrise) | Search the catalogue. Honest empty. | `NOT_RUN` | not exercised | `unassigned` |
| `/library/[id]` | staff admin (Sunrise) | Open one title, or record an honest empty. | `NOT_RUN` | not exercised | `unassigned` |
| `/library/circulation` | staff admin (Sunrise) | Open circulation. Honest empty. | `NOT_RUN` | not exercised | `unassigned` |
| `/library/holds` | staff admin (Sunrise) | List holds. Honest empty. | `NOT_RUN` | not exercised | `unassigned` |
| `/library/overdues` | staff admin (Sunrise) | List overdues. Honest empty. | `NOT_RUN` | not exercised | `unassigned` |
| `/library/fines` | staff admin (Sunrise) | List fines. Honest empty. | `NOT_RUN` | not exercised | `unassigned` |

## Hostel — `NOT_RUN`

`/hostel/attendance` is under Attendance. `/hostel/fees` is hostel billing, not the fees worker.

| Route | Actor | Primary action | Result | Evidence | Owner worker |
| --- | --- | --- | --- | --- | --- |
| `/hostel` | staff admin (Sunrise) | Open the hostel home. Honest empty if no hostel is seeded. | `NOT_RUN` | not exercised | `unassigned` |
| `/hostel/structure` | staff admin (Sunrise) | List houses, blocks, or rooms. Honest empty. | `NOT_RUN` | not exercised | `unassigned` |
| `/hostel/assignments` | staff admin (Sunrise) | List bed assignments. Honest empty. | `NOT_RUN` | not exercised | `unassigned` |
| `/hostel/leaves` | staff admin (Sunrise) | List hostel leaves. Honest empty. | `NOT_RUN` | not exercised | `unassigned` |
| `/hostel/gate-passes` | staff admin (Sunrise) | List gate passes. Honest empty. | `NOT_RUN` | not exercised | `unassigned` |
| `/hostel/visitors` | staff admin (Sunrise) | List visitors. Honest empty. | `NOT_RUN` | not exercised | `unassigned` |
| `/hostel/mess` | staff admin (Sunrise) | Open mess. Honest empty. | `NOT_RUN` | not exercised | `unassigned` |
| `/hostel/fees` | staff admin (Sunrise) | Open hostel fees. Honest empty. | `NOT_RUN` | not exercised | `unassigned` |

## Transport — `NOT_RUN`

`/transport/attendance` is under Attendance. `/transport/fees` is transport billing, not the fees worker.

| Route | Actor | Primary action | Result | Evidence | Owner worker |
| --- | --- | --- | --- | --- | --- |
| `/transport` | staff admin (Sunrise) | Open the transport home. Honest empty if no route is seeded. | `NOT_RUN` | not exercised | `unassigned` |
| `/transport/routes` | staff admin (Sunrise) | List routes. Honest empty. | `NOT_RUN` | not exercised | `unassigned` |
| `/transport/routes/new` | staff admin (Sunrise) | Open the new route form. Saving is optional. | `NOT_RUN` | not exercised | `unassigned` |
| `/transport/routes/[id]/stops` | staff admin (Sunrise) | Open stops for one route, or record an honest empty. | `NOT_RUN` | not exercised | `unassigned` |
| `/transport/vehicles` | staff admin (Sunrise) | List vehicles. Honest empty. | `NOT_RUN` | not exercised | `unassigned` |
| `/transport/assignments` | staff admin (Sunrise) | List student route assignments. Honest empty. | `NOT_RUN` | not exercised | `unassigned` |
| `/transport/live` | staff admin (Sunrise) | Open live tracking. Honest empty if no vehicle is reporting. | `NOT_RUN` | not exercised | `unassigned` |
| `/transport/alerts` | staff admin (Sunrise) | List transport alerts. Honest empty. | `NOT_RUN` | not exercised | `unassigned` |
| `/transport/fees` | staff admin (Sunrise) | Open transport fees. The seed has a school transport fee structure; show it if this screen reads fee structures, otherwise record the honest empty. | `NOT_RUN` | not exercised | `unassigned` |
