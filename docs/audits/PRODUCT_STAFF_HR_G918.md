...
| In scope                                                                                      | Non-goals                                       |
| --------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| `staff_contracts`, `staff_qualifications`, `staff_hr_attendance` (raw SQL + RLS)              | Live statutory payroll / tax / PF / ESI engines |
...
| Attendance | `/staff/attendance` | `/staff/attendance`, `/staff/attendance/summary` | `staff_hr_attendance`                | Staff                           |
