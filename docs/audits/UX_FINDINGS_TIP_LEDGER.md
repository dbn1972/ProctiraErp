...
| **Auth/Public worker** | `apps/web/src/app/(auth)/**`, `(public)/**`, `apps/public-website/**`, `apps/registration-portal/**` | AUTH-*, WWW-*, REG-* MFA/oauth/reset, legal residual, i18n/DOB-in-URL | Launching | — |
