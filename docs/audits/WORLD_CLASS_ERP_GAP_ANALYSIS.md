...
| **World-class functional parity** (this doc)    | Does each page do what PowerSchool / Banner / Workday users expect, end-to-end, with real data? | **5.4 / 10** weighted across 123 screens         |
...
| #   | Module                                        |       Screens | Score | World-class bar                      | Headline gap                                                                                                                                                               |
| --- | --------------------------------------------- | ------------: | ----: | ------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Students & enrollment                         |             7 |   6.5 | PowerSchool student 360°             | No photo/ID card/siblings/consent; synthetic attendance heatmap on profile; no promotion/rollover                                                                          |
| 2   | Staff / HR                                    |             8 |   6.0 | Workday HCM-lite                     | No contracts, staff attendance page, bulk import, payroll export                                                                                                           |
| 3   | Institutions & infrastructure                 |            12 |   4.5 | Banner org / OpenEMIS                | **`/academic-periods`, `/grades`, `/classes`, `/subjects`, `/infrastructure` not mounted on gateway** — 4 pages cannot load data; infra in-memory only; UDISE export inert |
| 4   | Academic periods & calendar                   |             2 |   4.0 | Infinite Campus calendar             | Backend unmounted (see #3); no year→term, holidays, grading windows, rollover                                                                                              |
| 5   | Attendance                                    |             2 |   6.0 | Infinite Campus attendance           | No regularisation, early-departure, student leave, biometric ingest; CSV export disabled                                                                                   |
| 6   | Admissions / registration                     | 1 (+7 portal) |   5.5 | Ellucian Recruit / Fedena admissions | No enquiry CRM, merit list, seat matrix, offer→fee→enrol conversion                                                                                                        |
| 7   | Assessments                                   |             5 |   6.5 | PowerSchool gradebook                | Outcomes & report-card templates have API but **no UI**; XLSX import is client-parsed JSON                                                                                 |
| 8   | Gradebook / transcripts                       |             2 |   6.5 | Banner grades                        | Workflow transitions not driveable from UI; no class rank / CGPA / comments bank; audit in-memory                                                                          |
| 9   | Examinations                                  |             7 |   4.5 | Board-exam ops (CBSE/ICSE)           | **Candidates GET missing, documents routes mismatch, results shape mismatch**; no invigilators, double-entry, re-evaluation; seating not persisted                         |
| 10  | Timetable / master schedule                   |             4 |   6.5 | aSc / Infinite Campus scheduler      | No auto-generation; classes/grades pages have disabled Add/Edit; no parent/student view                                                                                    |
| 11  | LMS + Spiral PAL                              |             4 |   6.0 | Canvas / Moodle                      | MCQ only; no question bank, rubrics, file uploads, discussions, content library, class analytics                                                                           |
| 12  | Curriculum                                    |             0 |   1.5 | Curriculum mapping (Atlas)           | Absent (outcomes API only)                                                                                                                                                 |
| 13  | Fees / student finance                        |             4 |   4.5 | Blackbaud Tuition / Fedena fees      | Flat plans only: no class/category structures, concessions, instalments, refunds, reminders, reports, reconciliation, scholarship netting                                  |
| 14  | Scholarships                                  |             7 |   6.0 | Banner financial aid                 | **Approve/Reject buttons not wired**; eligibility UI free-text; no netting to fees                                                                                         |
| 15  | Hostel                                        |             5 |   6.5 | Fedena hostel                        | No mess, gate pass, hostel fees, hostel attendance                                                                                                                         |
| 16  | Library                                       |             3 |   5.0 | Koha-class                           | No ISBN import, reservations, barcode, OPAC; fines API without UI                                                                                                          |
| 17  | Transport                                     |             5 |   5.5 | Fedena transport + telematics        | No stops UI, GPS map, bus-attendance UI, alerts, fee link                                                                                                                  |
| 18  | Health & wellbeing                            |             6 |   5.5 | SNAP Health / PowerSchool health     | List pages are gateway **seed aggregates**; no nurse incidents; vaccination/allergy UI missing; PHI log not viewable                                                       |
| 19  | Communication                                 |             4 |   6.0 | Remind / SchoolMessenger             | No WhatsApp, circulars, delivery-log console; sandbox delivery (waived)                                                                                                    |
| 20  | Notifications                                 |  1 (+1 admin) |   5.0 | —                                    | Rules editor is a stub; preferences link points to a **non-existent route**                                                                                                |
| 21  | Parent portal                                 |             5 |   5.0 | PowerSchool parent                   | No attendance, grades, timetable, calendar, LMS                                                                                                                            |
| 22  | Dashboard home                                |             1 |   5.0 | Role dashboards                      | Single layout; not role-personalised                                                                                                                                       |
| 23  | Tenant admin (users/roles/permissions/tenant) |             6 |   3.5 | Workday security admin               | Invite/Edit/Create/Save not wired; `/admin/users` list has no gateway route in matrix                                                                                      |
| 24  | Platform (billing/audit/tenant-lifecycle)     |             3 |   5.5 | —                                    | Read-only catalogues; audit store in-memory (not WORM)                                                                                                                     |
| 25  | Reports / BI                                  |             3 |   4.5 | Ellucian Insights / Power BI         | Generate returns synthetic downloads; no scheduling, role dashboards, real exports                                                                                         |
| 26  | Data warehouse                                |             4 |   3.5 | OpenEMIS DW                          | Field-mapping forced scaffold; map placeholder; DW/ETL packages unmounted                                                                                                  |
| 27  | Workflows                                     |             5 |   6.5 | Workday BP framework                 | No delegation, SLA config, trail view; two engines (`/workflows` UI vs `/workflow-engine`)                                                                                 |
| 28  | Auth (login/MFA/signup/reset/oauth)           |             9 |   7.5 | Okta-grade                           | No SCIM; live IdP waived (G-107); identity stores partly in-memory                                                                                                         |
| 29  | Help                                          |             1 |   5.0 | —                                    | No ticketing / release notes                                                                                                                                               |
| 30  | Public tracking `/track`                      |             1 |   7.0 | —                                    | OK                                                                                                                                                                         |
| —   | Registration portal app                       |             7 |   6.5 | —                                    | No admissions payment journey                                                                                                                                              |
| —   | Public website app                            |            12 |   6.0 | —                                    | No CMS; status page partial                                                                                                                                                |
| —   | Admin console app                             |            13 |   5.0 | —                                    | Backed by ui-seed platform-admin plugin                                                                                                                                    |
| —   | Developer portal app                          |             4 |   4.5 | —                                    | Marketplace static; keys not live-minted                                                                                                                                   |
| —   | Install wizard app                            |             1 |   5.0 | —                                    | `install` package unmounted                                                                                                                                                |
| —   | Mobile (Flutter)                              |           ~20 |   6.0 | —                                    | Single app; no dedicated student mode; device farm waived                                                                                                                  |
