...
| Metric | Value |
| --- | --- |
| Weighted program score | **9.0 / 10** (Services / Insights / Admin at 9.5; Portals 9.2; Mobile 9.1; Auth/IdP + device-farm still cap program) |
| Honest ceiling without IdP / device-farm | ~**9.0–9.2** |
