...
| ID / topic            | Decision                                                                                                                                                                                                                           |
| --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **F-1 / G-202**       | **Keep dated waiver** (`docs/audits/WAIVER_BOARD_20260910.md`) until PSP sandbox keys are available. Do not reopen as a build blocker for F1–F3. Slice **F4** later may refresh the waiver date or add sandbox e2e if keys appear. |
