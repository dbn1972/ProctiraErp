...
| ------ | ---------------------------------- | -------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| B3-001 | Transport live                     | Primary subtitle was developer-facing (`FORCE RLS`, JWT headers)                       | **Fixed** — user-facing line first; honesty note demoted to `text-xs` (`transport/live/page.tsx`) |
