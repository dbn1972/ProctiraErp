...
| ----------------------------- | ---------------------------------------------------------------- | --------------------------------- | --------------------------------------------------------------------- | ------------- | ----------------- | --------------------------- | ----------------------------------------------------- |
| **Notifications**             | Package + prefs/devices Pg                                       | Mounted                           | Inbox + prefs                                                         | Exists        | In gallery        | Inbox + FCM + prefs screens | Live delivery PG + SMS channel + tip CI               |
| **Communication / campaigns** | Package + Pg repo + audience/live counts + sandbox send/dispatch | `createCommunicationRepository()` | Campaigns create/list/preview/send; emergency dual-confirm + dispatch | Shells        | In gallery        | Thin                        | Provider adapters; guardian expansion; auth write E2E |
| **Transport**                 | Package + Pg repo                                                | `createTransportRepository()`     | Routes/vehicles/assignments forms + lists                             | 5 screens     | In gallery        | None                        | GPS optional; tip CI                                  |
