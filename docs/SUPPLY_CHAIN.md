...
| `signing-skipped`| Writes to the job summary *why* signing did not run (PR event, or variable unset).                                                                                                                                                                       | Never — it exists so a skipped signing step is visible, not silent.                                     |
